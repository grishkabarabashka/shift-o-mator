 ...
 * приоритет «роль > отсутствие > отгул > праздник > маркер» живёт в одном месте.
 */

import { memo } from 'react';
import type { CellStatus, CellValue, IsoDate, Issue, PersonId, ShiftRole } from '../../domain/types.ts';
...
function tooltipOf(
  ...
  if (role) {
    parts.push(`${role.code} ${role.start}–${role.end} (${shortZone(role.timeZone)})`);
