...
/// role code occupying the day, never layered on top of another (Docs/01).
///
/// <see cref="Date"/> is the local date of the shift in the *role's* timezone — that
...
public class Assignment
{
    ...
    /// <summary>Non-working by the person's *location* calendar (ADR-0002), not the role's.</summary>
