...
/// <summary>No separate "work pattern" entity — DefaultRoleId/AvailableWeekdays are read
...
public class Person
{
    ...
    /// <summary>Whose screen this person is planned on.</summary>
    ...
    public List<RoleEligibility> Eligibility { get; set; } = [];
}
