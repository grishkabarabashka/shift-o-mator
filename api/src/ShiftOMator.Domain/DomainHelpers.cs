...
{
    public static bool IsWorkingAssignment(Assignment a) => a.ContentKind == AssignmentContentKind.Role;

    public static string? AssignmentRoleId(Assignment a) => a.ContentKind == AssignmentContentKind.Role ? a.RoleId : null;
