        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultShiftId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    DefaultRoleId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrimaryTimeZone = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleEligibilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleEligibilities_People_PersonId",
                        column: x => x.PersonId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeRoleId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbsenceCapacityRules_Regions_RegionId",
                        column: x => x.RegionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DayConfigurations_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationRegion", x => new { x.LocationsId, x.RegionId });
                    table.ForeignKey(
                        name: "FK_LocationRegion_Locations_LocationsId",
                        column: x => x.LocationsId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationRegion_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shifts_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleRequirements_DayConfigurations_DayConfigurationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbsenceCapacityRules_RegionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DayConfigurations_RegionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationRegion_RegionId",
                table: "LocationRegion",
                column: "RegionId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleEligibilities_PersonId",
                table: "RoleEligibilities",
                column: "PersonId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleRequirements_DayConfigurationId",
