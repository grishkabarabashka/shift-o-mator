...
public static class TestFixtures
{
    ...
    public static readonly Region TestRegion = new()
    {
        Id = "R1",
        Name = "Test region",
    ...
    public static readonly ShiftDefinition TestShift = new()
    {
        Id = "sh-1",
        RegionId = TestRegion.Id,
        Code = "TEST",
    ...
    public static readonly ShiftRole LeadRole = new()
    {
        Id = "r-lead",
        RegionId = TestRegion.Id,
        Code = "Lead",
    ...
    public static readonly ShiftRole NightRole = new()
    {
        Id = "r-night",
        RegionId = TestRegion.Id,
        Code = "Night",
    ...
    public static DayConfiguration MakeDayConfig(
        ...
        List<RoleRequirement>? roleRequirements = null,
        ...
        DateOnly? date = null)
    {
        ...
        {
            Id = id,
            RegionId = regionId ?? TestRegion.Id,
            Key = key,
    ...
    public static Person MakePerson(
        ...
        List<RoleEligibility>? eligibility = null,
        ...
        OrgCategory orgCategory = OrgCategory.Support)
    {
        ...
        foreach (var e in eligibility ?? [new RoleEligibility { PersonId = "", RoleId = LeadRole.Id, TargetShare = 1 }])
        {
            e.PersonId = id;
    ...
    public static ScheduleDataset MakeDataset(
        ...
        List<ShiftDefinition>? shifts = null,
        List<ShiftRole>? roles = null,
        ...
        List<AbsenceCapacityRule>? absenceCapacityRules = null) => new()
    {
        ...
        Holidays = holidays ?? [],
        Regions = regions ?? [TestRegion],
        Units = units ?? [TestUnit],
        Shifts = shifts ?? [TestShift],
        Roles = roles ?? [LeadRole, NightRole],
